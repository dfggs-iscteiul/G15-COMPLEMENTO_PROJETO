...
function betterdocs_search_form( $atts, $content = null ) {
	...
	<div class="betterdocs-live-search">
		...
		<form id="betterdocs-searchform" class="betterdocs-searchform">
			...
			<input type="text" id="betterdocs-search-field" class="betterdocs-search-field" name="s" placeholder="<?php esc_html_e('Search..','betterdocs'); ?>" autocomplete="off" value="<?php the_search_query(); ?>">
