...
function betterdocs_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		...
		array(
			'label'      => __( 'Categroy Title Border Color', 'betterdocs' ),
			'section'    => 'betterdocs_doc_page_settings',
	...
	$wp_customize->add_control( new BetterDocs_Customizer_Range_Value_Control(
		...
		'label'    => __( 'Item Count Font Size', 'betterdocs' ),
		'priority' => 30,
		'input_attrs' => array(
			'class'  => '',
			'min'    => 0,
	...
	$wp_customize->add_control(
		...
		array(
			'label'      => __( 'Item Count Background Color', 'betterdocs' ),
			'section'    => 'betterdocs_doc_page_settings',
	...
	$wp_customize->add_control( new BetterDocs_Customizer_Range_Value_Control(
		...
		'label'    => __( 'Item Counter Size (Height, Width)', 'betterdocs' ),
		'priority' => 32,
		'input_attrs' => array(
			'class'  => '',
			'min'    => 10,
